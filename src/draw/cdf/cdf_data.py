...
df_batch_task.write.parquet(data_path + "batch_task_staging/job_duration_parquet")
# 
...
df_batch_instance.write.parquet(data_path + "batch_instance_staging/instance_duration_parquet")
