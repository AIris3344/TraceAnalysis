...
df_batch_task.write.parquet(data_path + "batch_instance_staging/task_duration")
# 
...
df_batch_instance.write.parquet(data_path + "batch_instance_staging/instance_duration")
